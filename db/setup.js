...
module.exports = async () => {
  ...
  await db.query(`INSERT INTO "menu_item" (name, restaurant_id, availability, has_allergens, description, price, type, img_url)
    VALUES  ('Fish Filet', 1, true, true, 'Wha she order?', 24.54, 'Seafood', 'https://imgur.com/9cT1gnQ.png'),
            ('Fish Sticks', 1, true, true, 'Delicious sticks of fish', 13.21, 'Seafood', 'https://imgur.com/hcnrtiy.png'),
            ('Fish Food', 1, true, true, 'Delicious food for fish', 6.56, 'Seafood', 'https://imgur.com/szk2qF8.png'),
            ('Salmon Sashimi', 1, true, true, 'Delicious sashimi', 21.50, 'Seafood', 'https://imgur.com/mhGna5f.png'),
            ('Crepe', 1, true, true, 'Delicious crepe', 2.54, 'Pastries', 'https://imgur.com/cgwnPpo.png'),
            ('Fancy Pizza', 2, true, true, 'Overpriced pizza', 12.10, 'Pizza', 'https://imgur.com/5rytLV6.png'),
            ('Fancy Pizza 2', 2, true, true, 'Overpriced pizza 2', 15.60, 'Pizza', 'https://imgur.com/hkfAkaZ.png'),
            ('McDouble', 3, true, true, 'Cheaper version of the double cheeseburger', 6.56, 'American', 'https://imgur.com/426n2Oh.png'),
            ('Cheeseburger', 3, true, true, 'Yum', 21.50, 'American', 'https://imgur.com/RXZse2e.png'),
            ('Big Mac', 3, true, true, 'Bigger than a regular Mac', 2.54, 'American', 'https://imgur.com/E28gLBO.png'),
            ('Double Cheeseburger', 3, true, true, 'Just like a cheeseburger, but double', 12.10, 'American', 'https://imgur.com/ZgQXcxJ.png'),
            ('Filet o'' Fish', 3, true, true, 'Delicious filet o fish with creamy sauce', 6.56, 'American', 'https://imgur.com/VnqRuaE.png'),
            ('Chicken Nuggets', 3, true, true, 'Good for snacking on', 21.50, 'American', 'https://imgur.com/Cs5xdEx.png'),
            ('French Fries', 3, true, true, 'French-style frites', 2.54, 'American', 'https://imgur.com/mxDLeTz.png'),
            ('"Coke"', 3, true, true, 'Columbian style "coke"', 12.10, 'Coke', 'https://imgur.com/knCzXHS.png'),
            ('Shio Ramen', '4', true, false, 'Umami Ramen', 10.99, 'Ramen', 'https://imgur.com/uYHfaBK.png'),
            ('Miso Ramen', '4', true, false, 'Miso flavour ramen', 10.99, 'Ramen', 'https://imgur.com/1dA6q9X.png'),
            ('Shoyu Ramen', '4', true, false, 'Soy Sauce flavour ramen', 10.99, 'Ramen', 'https://imgur.com/ZVMoExu.png'),
            ('Kara-miso Ramen', '4', true, false, 'Spicy Miso Ramen', 10.99, 'Ramen', 'https://imgur.com/iBAUttp.png'),
            ('California Roll', '5', true, false, 'Very Nice Sushi', 3.99, 'Japanese', 'https://imgur.com/BoHDLQV.png'),
            ('Unagi Don', '5', true, false, 'Melt in your mouth unagi', 20.99, 'Japanese', 'https://imgur.com/aGoCkt4.png'),
            ('Uni Don', '5', true, false, 'Custard of the sea', 30.99, 'Japanese', 'https://imgur.com/BrodXm2.png'),
            ('Omakase', '5', true, true, 'Chef Selection', 99.99, 'Japanese', 'https://imgur.com/RUDwibJ.png'),
            ('Meatballs', '6', true, true, 'Mediterranean Meat Balls', 10.99, 'Brunch', 'https://imgur.com/v4lTLB0.png'),
            ('Blueberry Waffles', '6', true, false, 'These waffles are blue and beautiful', 5.99, 'Brunch', 'https://imgur.com/h8CW3B2.png');
            `)
